...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>"></input>
	...
	{
	swal("Sorry","Password donot match.Please check!","error")
	}
	
	if(status=="invalidMobile")
	{
	swal("Sorry","Please enter the Mobile Number","error")
	}
	
	if(status=="invalidMobileLength")
	{
	swal("Sorry","Please enter the valid Mobile Number","error")
	}
	</script>
